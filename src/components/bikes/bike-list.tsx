          ...
          <div className="flex flex-1 flex-col gap-4 p-5">
            ...
            <div className="flex items-start justify-between">
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-brand-400 to-brand-600 text-white shadow-sm">
              ...
              <div className="flex shrink-0 flex-col items-end gap-1.5">
                ...
                <span className="rounded-md bg-surface-50 px-2 py-0.5 text-[10px] font-medium text-slate-500 ring-1 ring-surface-200">
